...
const canWeDeliver = (zipCode) => { 
    ...
    return `Sorry, the zipcode ${zipCode} cannot be serviced at this time`
}
console.log(canWeDeliver(85203))
console.log(canWeDeliver(34377))
/* 
    Problem 2 Continued
...
const canWeDeliverTwo = (zipcode) => {
    const zp = zipcode
    const here = deliveryAreaZipCodes.filter(element => element === zipcode)
    if(here.length>0){
        return `You're in our delivery zone!`
    }else{
        return `Sorry, the zipcode ${zp} cannot be serviced at this time`
    }
}
console.log(canWeDeliverTwo(85203))
console.log(canWeDeliverTwo(98765))
//////////////////PROBLEM 3////////////////////
/* 
